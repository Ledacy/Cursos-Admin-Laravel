...
export class CourseAddComponent implements OnInit {
  ...
  save(){
    ...
    if(!this.title || !this.subtitle || !this.precio_usd || !this.precio_pen || !this.categorie_id || !this.sub_categorie_id){
    ...
    formData.append("what_is_fors",this.what_is_fors);
